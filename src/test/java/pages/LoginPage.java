...
public class LoginPage extends BaseClass{
	...
	public void clickTextUsingClassName(String classname,String text) {
		java.util.List<WebElement> melement=  driver.findElements(By.className(classname));
	...
	public void clickArtigos(){
		log("Wait till video finished", ILogLevel.TEST);
		waitForAudioVideoFinished(By.id(LoginPageObject.artigos_id));
		clickTextUsingClassName(LoginPageObject.classname,"Artigos");
		takeScreenshot("Artigos");
	}
	
	public void clickCitacoes(){
		clickTextUsingClassName(LoginPageObject.classname,"Citações");
	...
	public void scrollScreen() {
		...
		log("Page scroll up to last test ["+getText(By.id(LoginPageObject.topText_id))+"].", ILogLevel.METHOD);
	}
	...
	public void clickEnter() {
		...
		click(By.xpath(LoginPageObject.enterButton_xpath), "ENTRAR", 2);
		}
	}
